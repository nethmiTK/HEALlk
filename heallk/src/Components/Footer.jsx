    ...
    <footer className="bg-gradient-to-br from-green-800 via-green-700 to-green-600 text-white">
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/#specializations" className="text-green-100 hover:text-white transition-colors duration-200">
                  Specializations
                </Link>
              </li>
              <li>
        ...
        <div className="bg-green-600 rounded-xl p-6 mb-8">
          <div className="text-center mb-4">
            ...
            <p className="text-green-100">Subscribe to our newsletter for health tips and updates</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 px-4 py-2 rounded-lg border-0 focus:ring-2 focus:ring-green-300 focus:outline-none"
            />
            <button className="bg-white text-green-600 px-6 py-2 rounded-lg font-semibold hover:bg-green-50 transition-colors duration-200">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="bg-red-600 text-white py-2">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-sm">
            🚨 <strong>Medical Emergency?</strong> Call 119 immediately for urgent assistance
          </p>
        </div>
      </div>
    </footer>
